      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="bg-white/5 border border-indigo-600 rounded-lg p-6 mb-8">
          ...
          <p className="text-sm text-gray-300 mb-4">
            Embed the BugLine widget in your app to enable instant bug reporting
            for users and auto-capture of JavaScript errors.
          </p>
    ...
    autoErrorCapture: true
          ...
          <ul className="list-disc pl-6 text-sm text-gray-200 mb-2">
            <li>
              ...
              : Unique per project. Required for authentication and bug
              submission.
            </li>
            <li>
              <span className="font-semibold text-indigo-300">position</span>:
              Floating button position. Options:{" "}
              <span className="font-mono">bottom-right</span>,{" "}
              <span className="font-mono">bottom-left</span>,{" "}
              <span className="font-mono">top-right</span>,{" "}
              <span className="font-mono">top-left</span>,{" "}
              <span className="font-mono">center-right</span>,{" "}
              <span className="font-mono">center-left</span>.
            </li>
            <li>
              <span className="font-semibold text-indigo-300">
                autoErrorCapture
              </span>
              : Enable automatic JS error reporting.
            </li>
            <li>
              <span className="font-semibold text-indigo-300">customCSS</span>:
              (Optional) Custom styling for widget button/modal.
            </li>
            <li>
              <span className="font-semibold text-indigo-300">Callbacks</span>:{" "}
              <span className="font-mono">onLoad</span>,{" "}
              <span className="font-mono">onBugReported</span>,{" "}
              <span className="font-mono">onError</span> for advanced usage.
            </li>
          </ul>
          <p className="text-xs text-gray-400 mt-2">
            For local testing, use the{" "}
            <span className="font-mono">widget.min.js</span> from{" "}
            <span className="font-mono">/packages/widget/dist/</span> and set{" "}
            <span className="font-mono">projectToken</span> to your test project
            token.
          </p>
        </div>
