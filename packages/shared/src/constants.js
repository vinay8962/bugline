...
export const API_ENDPOINTS = {
  ...
  COMPANIES: {
    ...
    REMOVE_MEMBER: (companyId, userId) =>
      `/api/v1/companies/${companyId}/members/${userId}`,
    UPDATE_MEMBER_ROLE: (companyId, userId) =>
  ...
  PROJECTS: {
    ...
    SEARCH_BY_COMPANY: (companyId) =>
      `/api/v1/companies/${companyId}/projects/search`,
    GET_BY_ID: (projectId) => `/api/v1/companies/projects/${projectId}`,
    UPDATE: (projectId) => `/api/v1/companies/projects/${projectId}`,
    DELETE: (projectId) => `/api/v1/companies/projects/${projectId}`,
  },
  ...
  BUGS: {
    ...
    SEARCH_BY_PROJECT: (projectId) =>
      `/api/v1/projects/${projectId}/bugs/search`,
